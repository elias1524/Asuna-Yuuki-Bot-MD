...
global.botnumber = '' //Ejemplo: +51950148255
global.confirmCode = ''
...
//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 💌
global.packname = '✦⃟⛧┋ ➪ Asᴜɴᴀ Yᴜᴜᴋɪ 🌸┋⃟✧'
global.author = 'J\no\ns\ne\n\nX\nr\nl\n'
global.wm = '⌬ 𝗠𝗼𝗱𝗶𝗳𝗶𝗲𝗱 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗫𝗿𝗹 ⭐'
global.titulowm = '✨✰ Asuna Yuuki ✰ - MD🌸'
global.titulowm2 = ''
global.igfg = '𝖬𝗈𝖽𝗂𝖿𝗂𝖾𝖽 𝖡𝗒 𝖣𝗂𝗈𝗇𝖾𝗂𝖻𝗂'
global.botname = '✧✩ *Asuna Yuuki* ✩✧'
global.dev = 'Ａｓｕｎａ Ｙｕｕｋｉ'
global.textbot = '𝑨𝒊 𝑨𝒔𝒖𝒏𝒂-𝒀𝒖𝒖𝒌𝒊 🌸..\nJose Xrl 🐢\nDioneibi 🚩\nRudeus Mods 😈\nKirito Domina 👑'
global.titu = 'Asᴜɴᴀ Yᴜᴜᴋɪ Bᴏᴛ...'
global.vs = '1.1.0'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Asᴜɴᴀ Yᴜᴜᴋɪ', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}

global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Asuna Yuuki', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '☆-Bɪᴇɴʙᴇɴɪᴅᴏ❞ ꔷ──᜔◇⃟̣̣⃕✨', jpegThumbnail: logo7 }}};

global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Asuna Yuuki', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: 'Asᴜɴᴀ Yᴜᴜᴋɪ', jpegThumbnail: logo8 }}};

global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Asuna-Yuuki', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: 'Sticker Asuna ｡^‿^｡ 🐢', jpegThumbnail: logo8 }}};

global.estilox = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Asuna Yuuki', orderTitle: 'packname', thumbnail: logo7, sellerJid: '0@s.whatsapp.net'}}}


//• ↳ ◜𝑳𝑰𝑵𝑲𝑺◞ • 🌿
global.id_canal = '120363337523216426@newsletter' //-ID de canal de WhatsApp
global.canal = 'https://whatsapp.com/channel/0029VaoRpDF5PO190ZCItg3D' //CANAL ASUNA YUUKI
