...
let text
   ...
   if (mishi.length > 30) return m.reply('➤ `𝗔𝗩𝗜𝗦𝗢` 🐢\n\n*EL TEXTO NO PUEDE TENER MAS DE 30 CARACTERES*');
m.react('🐢') 
    const pp = await conn.profilePictureUrl(who).catch((_) => 'https://i.ibb.co/rZcyhcL/file.jpg')
