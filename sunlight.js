...
global.authFile = `AsunaSession`
global.authFileJB = `AsunaJadiBot`
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Asuna-Bot', 'Edge', '2.0.0'] : methodCodeQR ? ['Asuna-Bot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log(chalk.black(chalk.bgGreen(`🚩 CÓDIGO DE 8 DÍGITOS:`)), chalk.bold.white(chalk.white(codeBot)))
}, 2000)
}}}
}
...
const subBotDirectory = './AsunaJadiBot';
...
const mainBotAuthFile = 'AsunaSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🚩 Ai Asuna conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🚩 Error al iniciar Asuna-Bot: `, error))
}
})();
